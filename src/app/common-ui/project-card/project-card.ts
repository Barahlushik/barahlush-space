  ...
  cards = [
    {
      ...
      tags: ['Angular', 'Exspress', 'SQlite', 'Nginx']
    },
    {
      name: 'PSP-club',
    ...
    },
    {
      ...
      description: 'A utility script for Yandex Disk that helps identify and resolve duplicate files by safely removing unnecessary data. It also supports dumping and transferring files between multiple cloud storage providers, streamlining cross-platform data management.',
